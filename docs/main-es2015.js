 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class NgxLightPaginationComponent {
    /**
     * @param {?} elRef
     * @param {?} differs
     */
...
/** @nocollapse */
NgxLightPaginationComponent.ctorParameters = () => [
...
/** @nocollapse */
UpArrowComponent.ctorParameters = () => [];
...
/** @nocollapse */
DownArrowComponent.ctorParameters = () => [];
...
/** @nocollapse */
RightArrowComponent.ctorParameters = () => [];
...
/** @nocollapse */
LeftArrowComponent.ctorParameters = () => [];
...
class NgxLightPaginationModule {
}
